        ...
        if event == sg.WIN_CLOSED or event == 'Exit':
            ...
            while True:
                ...
                if handData:
                    ...
                    cv2.putText(frame, f"{myGesture} ( ACCURACY: {accuracy}%, PRECISION: {precision}%, F1 SCORE: {f1}% )", (25, 125), cv2.FONT_HERSHEY_DUPLEX, 0.8, (255, 0, 0), 3)
                    ...
                    if myGesture in ['UP','DOWN','LEFT','RIGHT','FORWARD','BACKWARD','GRIP','UNGRIP','RESET','Go Auto']:
                        ...
                        if (current_time - last_send_time) > 3:  # Send a message every 1 second
