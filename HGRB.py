...
Main_layout = [
    ...
    [sg.Push(),sg.Text('HAND GESTURE RECOGNITION CONTROL FOR A CYLINDRICAL MANIPULATOR',
     font =("Cooper Black",20)),sg.Push()],
     
        [sg.Image(filename='logo-bsu.png',size = (200,184)),sg.Push(),sg.Frame('Fill out the following: ',[
            #[sg.Text('Input 1 to Train, Input 0 to Recognize: ', font = ('Times New Roman',15)),sg.InputText('0',key='TRAIN',size=(15,10))],
            ...
            [sg.Text('WIDTH for FRAME: ', font = ('Times New Roman',15)),sg.InputText('920',key='width',size=(15,10))]]),
        sg.Frame('GESTURE AVAILABLE:',[
            ...
            sg.Text('GO AUTO ', font = ('Times New Roman',15))]]),sg.Push(),sg.Image(filename='logo-mexe.png',size = (200,200))],
        [sg.Push(),sg.Button('RECOGNIZE', disabled=False ,font=("Arial Bold",20),button_color=('orange','purple')),
        sg.Button('TRAIN', disabled=False ,font=("Arial Bold",20),button_color=('yellow','brown')),sg.Push()],
...
def About_windows():
    ...
    about_layout=[
        ...
        [sg.Push(),sg.Text('Aaron Joshua M. Apolonia',font =("Time New Roman",15)),sg.Push()],
        [sg.Push(),sg.Exit(font = ('Times New Roman',13))]
    ]
        ...
        if event == sg.WIN_CLOSED or event == 'Exit':
            ...
            while True:
                ...
                if handData:
                    ...
                    precision = round((tol - dist) / tol * len(myGesture), 2) if dist <= tol else 0.0
                    
                    # Display the recognized gesture with accuracy and precision
                    cv2.putText(frame, f"{myGesture} ( ACCURACY: {accuracy}%, PRECISION: {precision}, TOLERANCE: 50) ", (25, 125), cv2.FONT_HERSHEY_DUPLEX, 0.8, (255, 0, 0), 3)
